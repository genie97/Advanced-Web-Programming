...
public class stateLookup {
	...
	public stateLookup() {
		...
		addState(new StatePair("Colorado", "CO"));
		...
		addState(new StatePair("California", "NH"));
		addState(new StatePair("California", "NJ"));
		addState(new StatePair("California", "NM"));
		addState(new StatePair("Nebraska", "NV"));
		addState(new StatePair("New Hampshire", "NY"));
